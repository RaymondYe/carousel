;(function(win, doc) {
  ...
  preloader.init = function() {
    ...
    pre.innerHTML = '<div class="load"><img class="load-xy" alt="loading" src="./img/logo.png"/><img class="load-word" alt="loading" src="./img/loading.png"/><div>'
    body.appendChild(pre)

    this.imgArr = ['./img/ca.jpg', './img/bg-1.jpg', './img/bottom-icon.png', './img/music.png']
